...
const EmailConfirmationForm = ({ pendingEmail }: Props) => {
	...
	return (
		<form onSubmit={submitCode}>
			...
			<p className="mb-4 text-sm sm:text-justify">
				<FormattedMessage
			...
			<div className="mt-4 flex flex-col sm:flex-row space-y-2 sm:space-y-0 justify-end items-end sm:items-center text-sm sm:text-base">
				<button
					type="button"
