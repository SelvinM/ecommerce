...
const Checkout: NextPage<Props> = ({}) => {
	...
	const [payAtDelivery, setPayAtDelivery] = useState<boolean>(false);
	...
	}, [cartData, placeOrderClicked, payAtDelivery]);
	...
	const checkPlaceOrderErrors = () => {
		...
		if (!paymentMethod && !payAtDelivery) {
			setPlaceOrderErrorMsg(
											...
											<div className="lg:mb-8" id="checkout-payments">
												...
												>
													<CheckoutPayments
														...
														setPayAtDelivery={setPayAtDelivery}
													/>
												</Card>
											</div>
										</div>
